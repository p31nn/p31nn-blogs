...
export default function Footer() {
    return (
        <footer className="bg-gray-100 py-8 dark:bg-gray-800 mt-100">
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-4">
                            <a 
                                href="https://www.instagram.com/p31nn/" 
                                target="_blank" 
                    ...
                    <div className="space-y-4">
                        ...
                        <form>
                            <div className="flex space-x-2">
                                <Input type="email" placeholder="Enter your email" className="flex-1S" />
                ...
                <div className="mt-8 border-t border-gray-200 pt-4 text-center text-xs text-gray-500 dark:border-gray-700 dark:text-gray-400">
                    &copy; 2024 P31NN. All right reserved.
                </div>
            </div>
        </footer>
    );
